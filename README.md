...
<img src="https://github.com/swuxyj/DeepHash-pytorch/blob/master/pr.png"  alt="Precision Recall Curve"/><br/>  
...
```
To get the Precision Recall Curve, you can copy the data (which is generated by the above code ) to A_Precision_Recall_Curve.py  and run this file.  
```
pyhon A_Precision_Recall_Curve.py   
```
# Dataset
